...
loginBtn.addEventListener("click", () => {
  ...
  if (email !== "mohdsah5@gmail.com") {
    statusEl.textContent = "Hanya akaun admin dibenarkan.";
    return;
  }
  ...
  signInWithEmailAndPassword(auth, email, password)
    .then(() => {
      ...
      statusEl.textContent = "Login berjaya. Redirect...";
      setTimeout(() => {
        window.location.href = "adminTown.html";
      }, 1000);
    })
    .catch((error) => {
